...
function loadExperiment(opt, dictSizePos, dictSizeDeps, outputSize, digitsDataLength, wordsDataLength, posDataLength, depsDataLength)
...
dataset = loadDataset(train, valid, nRels - 3, 24, 10, 2, 2)

xp = loadExperiment(opt, nPos, nDeps, nRels - 3, 24, 10, 2, 2)
xp:run(dataset)
